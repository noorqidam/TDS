      ...
      <div className="user-profile">
        <div className="user-profile-grid">
          ...
          <div className="user-stats">
            <ul>
              <li className="user-following" onClick={(event) => this.getUserData(event, `${this.props.user.url}/following`)}>
                <b>{this.props.user.following}</b>
                <p>Following</p>
              </li>
              <li className="user-followers" onClick={(event) => this.getUserData(event, `${this.props.user.url}/followers`)}>
                <b>{this.props.user.followers}</b>
                <p>Followers</p>
              </li>
              <li className="user-following" onClick={(event) => this.getUserData(event, `${this.props.user.url}/repos`)}>
